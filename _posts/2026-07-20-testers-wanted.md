...
RightNow has been my side project for a long time, and it's finally close to a proper public release on Google Play. There's one thing standing between here and there that I genuinely cannot do alone: Google requires testers.
...
So I need a dozen people willing to put RightNow on their phone and genuinely use it for two weeks. If you've ever wanted to nudge this project over the line, this is the single most useful thing you can do.
