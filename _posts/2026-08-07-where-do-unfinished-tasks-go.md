...
Here's what happens in practice with automatic rollover. Monday you plan eight tasks and do six. Tuesday starts with two leftovers plus whatever Tuesday brings. By Friday your "today" list is a fossil record of the whole week, and the app has quietly stopped telling you what you chose to do and started reminding you what you didn't.

The entire point of RightNow is that Today is a choice. You have a certain amount of capacity, you decide what deserves it, and the app pushes back when you overcommit. An auto-rolling backlog breaks that at the root: it spends your capacity for you, on yesterday's decisions, before you've even had your coffee.
...
**A quiet word about repeat offenders.** The app now counts how many times a task has rolled over. Once something has slipped three times, it stops being "overdue" and starts being a task that's probably lying to you about how much you want it. Rather than letting it climb the priority ladder forever, the Keep or Delete refinement game now deals those chronic tasks first, so the next time you play a round, the app gently asks the question you've been avoiding: do you actually want to do this, or shall we let it go?
...
This lot will reach testers in the next build. If you're on the testing list and the banner annoys you, or the chip isn't obvious enough, tell me. This whole feature exists because someone told me what wasn't working, and it ended up somewhere better than what either of us had in mind at the start.
